...
namespace ArkitPlanetsDemo
{
    ...
    {
		double rotationSun = 80;
        double rotationEarth = 150;
        double rotationMoon = 30;
        double rotationMars = 160;
		...
		SCNNode marsParentNode, eartParentNode;
		bool planetsMove;
		UIButton btnRun;
